...
function ju_misc_customizer_section($wp_customize){
	// first create the database value using add setting method
	$wp_customize->add_setting('ju_header_show_search',array(
		'default' => 'yes',
		'transport' => 'postMessage'
	));
	 //for chaning it will by default set refresh the page whenever changes made so restric that load from javsacript to set this to postMessage okkay
	...
	$wp_customize->add_control(new WP_Customize_Control(
	        ...
	        array(
	            ...
	            'type'           => 'dropdown-pages' //  you can set the value 0 to tell wordpress we dont want to select any page.
	        )
