<div class="entry clearfix">
                ...
                <div class="slider-wrap">
                    ...
                    <div class="slide">
                        <a href="<?php echo $src; ?>" data-lightbox="gallery-item">
                            <img class="image_fade" src="<?php echo $src; ?>" alt="Standard Post with Gallery">
                        </a>
                    </div>
                    <?php endforeach ?>
    ...
    <?php }else if (get_post_format() === 'video'){
        ...
        if(!strpos($content,'wp-playlist-script')){
            //i will use this function to check that if user has embed a playlist
         ...
         ?>
        <?php if ($video): ?>
          <div class="entry-video"><?php echo $video[0]; ?></div>    
        <?php endif ?>
    ...
    <ul class="entry-meta clearfix">
        ...
        <li><i class="icon-folder-open"></i> <?php the_category( $separator = ' ' ); ?></li>
        <li><a href="single.html#comments"><i class="icon-comments"></i> <?php comments_number('0') ?> Comments</a></li>
    </ul>
